            ...
            <div class="custom-tabs">
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <a class="nav-link show active " data-bs-toggle="tab" id="family-main-tab" href="#leave-content" role="tab"
                            aria-selected="false">
                            <span class="hidden-xs-down" style="font-size: 0.9em;"><i
                                    class="fas fa-plane-departure tab-icon"></i> Leave Approval </span>
                        </a>
                    </li>
                </ul>
