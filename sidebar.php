...
<script>
        // Safe loader helpers: don't assume loader DOM exists and avoid binding global onload here
        function showLoader() {
            const lc = document.getElementById('loaderContainer');
        ...
        document.addEventListener("DOMContentLoaded", function() {
            // Cache DOM elements that exist in this scope
            const elements = {
