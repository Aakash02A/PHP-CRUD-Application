        ...
        <div class="breadcrumb-area custom-gradient">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">InfoTab</li>
                </ol>
            </nav>
        </div>
        ...
        <div class="container-fluid">
            <div class="custom-tabs">
                ...
                <div class="tab-content mt-3">
                    ...
                    <div class="tab-pane fade show active" id="academics-content" role="tabpanel" aria-labelledby="academics-tab">
                        <div class="d-flex justify-content-end my-3">
                            <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#staticBackdrop1">
                                <i class="fa-solid fa-plus" ></i> Add Academic Details
                            </button>
                        </div>
                    ...
                    <div class="tab-pane fade" id="leave-content" role="tabpanel" aria-labelledby="leave-tab">
                        <div class="d-flex justify-content-end my-3">
                            <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#staticBackdrop2">
                                <i class="fa-solid fa-plus" ></i> Add Leave / OD Details
                            </button>
                        </div>
                        <div class="card shadow mb-4">
                    ...
                    <div class="tab-pane fade" id="family-content" role="tabpanel" aria-labelledby="family-tab">
                        <div class="d-flex justify-content-end my-3">
                            <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#staticBackdrop3">
                                <i class="fa-solid fa-plus" ></i> Add Family Member Details
                            </button>
                        </div>
                        <div class="card shadow mb-4">
                            <div class="card-body">
                    ...
                    <form id="academicDetailsForm">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="Board" name="board" required>
                                ...
                                <option value="SB">State Boards</option>
